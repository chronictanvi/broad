    ...
    <div className="h-screen flex flex-col md:flex-row overflow-hidden">
      <div className="flex flex-col md:flex-row sticky top-0 z-10 w-full">
        {agencies.map((agency) => (
          ...
          >
            <div className="h-full overflow-y-auto flex flex-col snap-container">
                        ...
                        <>
                          ...
                          >
                            ...
                            {agency.title.map((line, index) => (
                              <p
                                key={index}
                                className={`text-3xl font-light ${agency.textColor} transition-all duration-500 mb-4`}
                              >
                                {line}
                              </p>
                            ))}
                            ...
                            <p className="mx-20">
                              ...
                              produce ever-growing reams of data and
                              cutting-edge computational approaches are trained
                              to interpret them. Sequencing centers are churning
                              out hundreds of thousands of genomes a day.
                              Laboratories are now able to profile millions of
                              cells in an experiment. Machine learning is
                              scanning many millions of medical images to find
                              new patterns. But at the Broad Institute, scale
                              means something different. It's more than just
                              size—it's about taking systematic, unbiased
                              approaches and going where the data leads you.
                              It's about traversing reams of cellular data and
                              uncovering a lead that could someday help solve a
                              medical mystery. It's about shifting through
                              millions of proteins to build one that could
                              someday be a new gene-editing tool. Or taking
                              everything we know about the genetic changes
                              cancer cells undergo, figuring out which ones they
                              need to survive, and giving access to the research
                              community so we can get to clinical trials more
